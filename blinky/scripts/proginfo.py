...
if sys.argv[1] == 'prog-artya7-35t':
    ...
    boardConfig = os.path.join(os.getcwd(), "../src/"+system_name, "openocd/LFE5U-85F.cfg")
    bitFile = os.path.join(os.getcwd(), system_name+".svf")
    print("> openocd -f {} -f {} -c \"transport select jtag; init; scan_chain; svf -quiet -progress {}; exit\"".format(interfaceConfig, boardConfig, bitFile))
