...
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { io_led0 }];

set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports { io_led1 }];
set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVCMOS33 } [get_ports { io_led2 }];
