...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS25 } [get_ports { io_led0 }]

set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS25 } [get_ports { io_led1 }]
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS25 } [get_ports { io_led2 }]
